...
router.post('/', async function (req, res, next) {
    ...
    if (action == 'divison' && dbtype == 'mongodb') {
        ...
        var uri = 'https://lsp.wuliu.taobao.com/locationservice/addr/output_address_town_array.do';
        var data = await rp({
            uri: uri,
            qs: { l1: '440000', l2: '441900', l3: '', lang: 'zh-S', _ksTS: '1532877390692_7890', callback: 'jsonp' }
        });  
        await eval(data);

        data = await rp({
            uri: uri,
            qs: { l1: '440000', l2: '442000', l3: '', lang: 'zh-S', _ksTS: '1532877390692_7890', callback: 'jsonp' }
        });  
        await eval(data);

        data = await rp({
            uri: uri,
            qs: { l1: '460000', l2: '469003', l3: '', lang: 'zh-S', _ksTS: '1532877390692_7890', callback: 'jsonp' }
        });  
        await eval(data);

        data = await rp({
            uri: uri,
            qs: { l1: '620000', l2: '620200', l3: '', lang: 'zh-S', _ksTS: '1532877390692_7890', callback: 'jsonp' }
        });  
        await eval(data);
